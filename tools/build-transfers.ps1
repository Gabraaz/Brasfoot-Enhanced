...
& "$jdkPath\javac.exe" --release 8 -encoding UTF-8 -cp "$buildPath\game.jar" -d "$buildPath\classes" "$PSScriptRoot\NegotiationRules.java" "$PSScriptRoot\TransferNegotiation.java" "$PSScriptRoot\NegotiationRulesTest.java"
